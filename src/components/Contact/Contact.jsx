...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_9pyvvnj",  // Replace with your EmailJS Service ID
        "template_pnikg3l",  // Replace with your EmailJS Template ID
        form.current,
        "qKsXPiOTJh-hKRlkp"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          "Hi there! Feel free to drop your queries—I’ll get back to you as soon as possible."
        </p>
      </div>
